...
print("predication of  Test Data(Incep.):")
print("start load model.....")
incep_freeze= load_model('/home1/nour/sherouk/New_task/DATASET_101/inception.h5')
print("start predication process.....")
incep_test_preds = incep_freeze.predict(X_test)
print("save predication file.....")
np.save('/home1/nour/sherouk/New_task/DATASET_101/incep_test_preds.npy', incep_test_preds)
print("Evaluation process and create text file of results.....")
evaluate_model(np.argmax(incep_test_preds, axis=1), Y_test,"incep_test")

print("predication of  Test Data(DenseNet):")
print("start load model.....")
DenseNet_freeze= load_model('/home1/nour/sherouk/New_task/DATASET_101/densenet.h5')
print("start predication process.....")
DenseNet_test_preds =DenseNet_freeze.predict(X_test)
print("save predication file.....")
np.save('/home1/nour/sherouk/New_task/DATASET_101/DenseNet_test_preds.npy',DenseNet_test_preds)
print("Evaluation process and create text file of results.....")
evaluate_model(np.argmax(DenseNet_test_preds, axis=1), Y_test,"DenseNet_test")
