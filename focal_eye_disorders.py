...
# Compile the model
Resnet101_freeze.compile(optimizer='adam', loss=tf.keras.losses.CategoricalFocalCrossentropy(), metrics=['accuracy'])
...
# Compile the model
Resnet50_freeze.compile(optimizer='adam', loss=tf.keras.losses.CategoricalFocalCrossentropy(), metrics=['accuracy'])
...
# Compile the model
vgg19_freeze.compile(optimizer='adam', loss=Stf.keras.losses.CategoricalFocalCrossentropy(), metrics=['accuracy'])
