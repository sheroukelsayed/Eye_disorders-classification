...
# Load the biomedical image
image_path = '/home1/nour/sherouk/New_task/DATASET_101/Train/ACRIMA/Im147_ACRIMA.jpg' 
...
if original_image is None:
    ...
    adjusted_image = cv2.convertScaleAbs(original_image, alpha=alpha)

    # Plotting the original and adjusted images side by side
...
# Compile the model
Resnet101_freeze.compile(optimizer='adam', loss=SparseCategoricalFocalLoss(gamma=2), metrics=['accuracy'])

# Train the model
Resnet101_freeze.fit(X_train, y_train, epochs=15, batch_size=32, validation_data=validation_data )

Resnet101_freeze.save('/home1/nour/sherouk/New_task/DATASET_101/focalresnet101.h5')
...
# Compile the model
Resnet50_freeze.compile(optimizer='adam', loss=SparseCategoricalFocalLoss(gamma=2), metrics=['accuracy'])
...
Resnet50_freeze.save('/home1/nour/sherouk/New_task/DATASET_101/focalresnet50.h5')
...
# Compile the model
vgg19_freeze.compile(optimizer='adam', loss=SparseCategoricalFocalLoss(gamma=2), metrics=['accuracy'])

# Train the model
vgg19_freeze.fit(X_train, y_train, epochs=15, batch_size=32, validation_data= validation_data)
#vgg19_freeze=load_model('/home1/nour/sherouk/New_task/DATASET_101/focalVGG16.h5')
vgg19_freeze.save('/home1/nour/sherouk/New_task/DATASET_101/focalVGG16.h5')
...
np.save('/home1/nour/sherouk/New_task/DATASET_101/focal_resnet50_val_preds.npy', resnet50_val_preds)
np.save('/home1/nour/sherouk/New_task/DATASET_101/focal_resnet101_val_preds.npy',resnet101_val_preds)
np.save('/home1/nour/sherouk/New_task/DATASET_101/focal_vgg19_val_preds.npy', vgg19_val_preds)
...
def evaluate_model(predictions, true_labels, Model_name):
    ...
    with open("/home1/nour/sherouk/New_task/DATASET_101/"+ Model_name +"_evaluation_results.txt", "w") as file:
...
evaluate_model(np.argmax(resnet50_val_preds, axis=1), np.argmax(y_valid, axis=1),"focal_resnet50")
evaluate_model(np.argmax(resnet101_val_preds, axis=1),np.argmax(y_valid, axis=1),"focal_resnet101")
evaluate_model(np.argmax(vgg19_val_preds, axis=1),np.argmax(y_valid, axis=1),"focal_vgg16")
